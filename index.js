...
const connectionString = 'mongodb+srv://admin:admin@cluster0.p5n2s.mongodb.net/ocean-backend-mongodb?retryWrites=true&w=majority';
...
const db = client.db('ocean-backend-mongodb');
